          ...
          >
            <ol className="bg-base bg-op-70! backdrop-blur-md p-2 rounded-lg color-base text-base">
              ...
              <li className="flex gap-2 items-center">
                <a
                  href="https://github.com/liangzaiv/newsnow"
                >
                  <img
                    alt="GitHub stars badge"
                    src="https://img.shields.io/github/stars/liangzaiv/newsnow?logo=github"
                  />
                </a>
                <a
                  href="https://github.com/liangzaiv/newsnow/fork"
                >
                  <img
                    alt="GitHub forks badge"
                    src="https://img.shields.io/github/forks/liangzaiv/newsnow?logo=github"
                  />
                </a>
              </li>
            </ol>
